# ABOUTME: Tests for politician votes API endpoint
# ABOUTME: Includes pagination, filtering, sorting, and SQL injection protection tests
...
class TestPoliticianVotes:
    ...
    def test_vote_structure(self, client):
        ...
        if len(data['votes']) > 0:
            vote = data['votes'][0]
            required_fields = [
                'VoteID', 'Vote', 'BillNumber', 'Title',
                'DateIntroduced', 'subjects'
            ]
