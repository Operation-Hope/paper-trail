# ABOUTME: Tests for donation summary API endpoints
# ABOUTME: Includes unfiltered and filtered donation summaries with SQL injection protection
...
class TestFilteredDonationSummary:
    ...
    def test_filtered_summary_with_empty_topic(self, client):
        ...
        response = client.get(
            '/api/politician/1/donations/summary/filtered?topic='
        )
        assert response.status_code == 400
    ...
    def test_all_topic_mappings_exist(self, client):
        ...
        all_topics = [
            "Health", "Finance", "Technology", "Defense",
            "Energy", "Law", "Education", "Foreign Relations",
