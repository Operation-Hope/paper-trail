# ABOUTME: Tests for donor search and donation API endpoints
# ABOUTME: Includes SQL injection protection validation and data integrity tests
...
class TestDonorsSearch:
    ...
    def test_sql_injection_union_select(self, client):
        ...
        malicious_input = "' UNION SELECT DonorID,Name,DonorType,Employer,State FROM Donors --"
        response = client.get(f'/api/donors/search?name={malicious_input}')
