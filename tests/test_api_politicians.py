# ABOUTME: Tests for politician search API endpoints
# ABOUTME: Includes SQL injection protection validation and edge case testing
...
class TestPoliticiansSearch:
    ...
    def test_search_returns_politician_fields(self, client):
        ...
        if len(data) > 0:
            politician = data[0]
            required_fields = [
                'politicianid', 'firstname', 'lastname',
                'party', 'state', 'role', 'isactive'
            ]
